...
const CryptoAndAlertObject = { ...cryptoInfo, alert_infereior_value: valueInf, alert_superior_value: valueSup }
//console.log(CryptoAndAlertObject)
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Crypto Alerts</Text>
      <Text style = {styles.subtitle}>Alerta para valor de limite inferior (R$)</Text>
      <TextInput
        style={styles.input}
      ...
      <Text style = {styles.subtitle}>Alerta para valor de limite superior (R$)</Text>
      <TextInput
        style={styles.input}
        placeholder="Digite aqui"
        value={valueSup}
